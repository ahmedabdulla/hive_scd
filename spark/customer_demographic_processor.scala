...
case class CustomerDemo(icustId: Int, iPurchYTD: JavaBigDecimal, firstPurDt : Date, bDate : Date, 
	marStatus : String, yIncome : String, gnder : String, totChildren : JavaByte, noChildHome : JavaByte, 
	educatn : String, occupatn : String, homeOwnFlag : String, noCarOwnd : JavaByte, 
	commDist : String, crtDate : Date) extends java.io.Serializable
